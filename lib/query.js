...
class Query {
    ...
    getDeptIds(role) { // gets names and IDs only for Inquirer choice list
    ...
    getAllDeptIds() { // gets names and IDs only for Inquirer choice list
        return this.db.promise().query(`SELECT dept_name AS name, id AS value FROM departments;`);
    }
    getRoleIds() { // gets names and IDs only for Inquirer choice list
        return this.db.promise().query(`SELECT title AS name, id AS value FROM roles;`);
    }
    getManagerIds() { // gets names and IDs only for Inquirer choice list
    ...
    getEmplIds() { // gets names and IDs only for Inquirer choice list
    ...
    deleteRole(roleId) {
        return this.db.promise().query(`DELETE FROM employees WHERE id = ${roleId};`);
    }
    deleteEmpl(emplId) {

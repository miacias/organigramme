...
const { deptChoices, roleChoices, managerChoices } = require("./populateList.js");
// const myManager = managerChoices();
...
class CLI {
    ...
    addEmployee() {
        return inquirer
            ...
            .then((answers) => {
                const { firstName, lastName, roleId, mgmtId } = answers;
                let query = new Query(db);
                query.addEmployee(firstName, lastName, roleId, mgmtId)
                    .then(() => {

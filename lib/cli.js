            ...
            .prompt([
                {
                    ...
                    choices: [
                        ...
                        // "Disband Department", // bonus (ISSUE: causes roles & employee removal)
                        // "Remove Role", // bonus (ISSUE: causes employee removal)
                        // "Off-Board Employee", // bonus (ISSUE: causes "extra managers" on viewManagers())
                        new inquirer.Separator(),
                        "Exit",
                        new inquirer.Separator()
                    ...
                    .prompt([
                        {
                            type: "list",
                            name: "deptId",
                            message: "Select department to disband. WARNING: All remaining employees will no longer have a designated department.",
                            choices: departments
                        }
                    ])
                    .then((answers) => {
                    ...
                    .prompt([
                        {
                            type: "list",
                            name: "roleId",
                            message: "Select department to disband. WARNING: All remaining employees will no longer have a designated role.",
                            choices: roles
                        }
                    ])
                    .then(chosenRole => {
                        let role = chosenRole.roleId;
                        query.deleteRole(roleId)
                            .then(() => {
